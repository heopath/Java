...
public class StringTest {
	public static void main(String[] args) {
		...
		System.out.println("message길이 : " + message.length());
		...
		String sub2 = message.substring(7); // 7부터 마지막까지
		
		System.out.println("sub1 : " + sub1);
		System.out.println("sub2 : " + sub2);
		
		// 문자열 인덱스
		int index1 = message.indexOf("l");     // 문자열 앞에서 부터 소문자 l 검색
		int index2 = message.lastIndexOf("l"); // 문자열 뒤에서 부터 소문자 l 검색
		...
		String replaced2 = message.replace("World", "Welcome");		
		...
		String result3 = ""+var3;			   // 빈문자열로 변환 var+""도 가능
